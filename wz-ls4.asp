...
<html>
	...
	<body>
		...
		<div class="zhezhao"></div>
			...
			<h1>机遇号的一生</h1>
			<p>机遇号的一生，这段视频中的画面来自机遇号的原始格式RAW图像，声音是真实的火星风，视频由melodysheep制作而成。</p>
			<video src="img/6/4/4/1.mp4" controls="controls" width="100%" height="100%"></video>
			</section>
