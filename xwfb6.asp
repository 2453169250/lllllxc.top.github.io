...
<html>
	<head>
		<meta charset="utf-8">
		<title>嫦娥五号轨道器和返回器组合体实施第二次月地转移入射</title>
	...
	<body>
		<div class="beijing1"></div>
			...
			<section class="wz-section">
				<h1>嫦娥五号轨道器和返回器组合体实施第二次月地转移入射</h1>
				<p>北京时间12月13日9时51分，嫦娥五号轨道器和返回器组合体实施第二次月地转移入射，在距月面约230公里处成功实施四台150牛发动机点火，约22分钟后，发动机正常关机。根据实时遥测数据监视判断，轨道器和返回器组合体成功进入月地转移轨道。</p>
				<p>后续，携带月球样品的嫦娥五号轨道器和返回器组合体将在月地转移过程中进行中途轨道修正，并择机实施轨道器和返回器的分离。</p>
				<img src="img/7/06.jpg" >
				<center><i>嫦娥5号探测器月地转移轨道示意图</i></center>
			</section>
