...
<html>
	<head>
		...
		<title>50年前的今天，阿波罗12号发射升空</title>
	...
	<body>
		...
		<div class="zhezhao"></div>
			...
			<h1>50年前的今天，阿波罗12号发射升空</h1>
			<video src="img/6/4/5/1.mp4" controls="controls" width="100%" height="100%"></video>
			<p>1969年11月14日，阿波罗12号从肯尼迪航天中心发射升空。土星五号升空后的36秒和52秒，两次被闪电击中，仪表盘上多处显示异常。</p>
			<p>所幸地面飞行控制员John Aaron在一次模拟飞行中见过类似的情形，指导宇航员们从SCE切换到AUX，重启燃料电池系统，仪表盘这才恢复正常。</p>
			</section>
